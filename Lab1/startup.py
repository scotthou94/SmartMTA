...
# Robert Fea (rf2638)
# IoT Lab 1
# Script to beep buzzer at boot time and send email
...
# Account Information
to = 'mja2196@columbia.edu' # Email to send to.
gmail_user = 'scapegoatdummy@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'uselessaccount' # Gmail password.
